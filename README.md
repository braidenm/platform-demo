...
1. **Build & Test**: Runs the Gradle build and service-level tests. The identity service tests are currently compose-backed and run against live Postgres/Mongo infrastructure.
